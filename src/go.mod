module github.com/moveaxlab/jumpcloud-teleport-sync
...
replace github.com/gravitational/teleport/api => github.com/gravitational/teleport/api v0.0.0-20260317082232-8e2f75a63cc7
